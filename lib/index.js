...
var getBaseBranch = function (config) {
...
var getHeadBranch = function (config) {
...
var openPullRequest = function (config) { return __awaiter(void 0, void 0, void 0, function () {
    var ghArgs;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                if (config.specifyBase) {
                    ghArgs = __spreadArrays(ghArgs, ['--base', config.baseBranch]);
                }
                if (config.specifyHead) {
                    ghArgs = __spreadArrays(ghArgs, ['--head', config.headBranch]);
                }
                ghArgs = __spreadArrays(ghArgs, ['--title', '[Dup File Action] automated file duplication']);
                ghArgs = __spreadArrays(ghArgs, ['--body', 'File duplication']);
                return [4 /*yield*/, exec.exec('gh', ghArgs)];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
...
var uploadChanges = function (config) { return __awaiter(void 0, void 0, void 0, function () {
    var method, head;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 3:
                ...
                return [3 /*break*/, 16];
            case 4:
                if (!(method === 'pull_request')) return [3 /*break*/, 10];
                return [4 /*yield*/, exec.exec('git', ['checkout', '-b', head])];
            case 5:
                _a.sent();
                return [4 /*yield*/, exec.exec('git', ['add', '-A'])];
            case 6:
            ...
            case 7:
                _a.sent();
                return [4 /*yield*/, exec.exec('git', ['push', '-f', '-u', 'origin', head])];
            case 8:
                _a.sent();
                return [4 /*yield*/, openPullRequest(config)];
            case 9:
                _a.sent();
                core.info('Pull request opened.');
                return [3 /*break*/, 16];
            case 10:
                if (!(method === 'dry_run')) return [3 /*break*/, 15];
                return [4 /*yield*/, exec.exec('git', ['checkout', '-b', head])];
            case 11:
                _a.sent();
                return [4 /*yield*/, exec.exec('git', ['add', '-A'])];
            ...
            case 13:
                _a.sent();
                return [4 /*yield*/, exec.exec('gh', ['issue', 'list'])];
            case 14:
                _a.sent();
                return [3 /*break*/, 16];
            case 15: throw Error("Method " + method + " not found.");
            case 16: return [2 /*return*/];
        }
    });
}); };
var main = function () { return __awaiter(void 0, void 0, void 0, function () {
    var config, configFiles, globber, globalConfig, outdated, _a, _b, file, configContent, parsedConfig, targetFile, e_1_1, _c, _d, _i, target, dupFiles;
    var e_1, _e;
    return __generator(this, function (_f) {
        switch (_f.label) {
            ...
            case 17:
                ...
                return [3 /*break*/, 15];
            case 18:
                if (!outdated) return [3 /*break*/, 20];
                return [4 /*yield*/, uploadChanges(config)];
            case 19:
                _f.sent();
                return [3 /*break*/, 21];
            case 20:
