...
var configureGit = function () { return __awaiter(void 0, void 0, void 0, function () {
    var email, username, token, homeDie;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                homeDie = process.env['HOME'];
                return [4 /*yield*/, io.mkdirP(homeDie + "/project_temp/file-dup-action/")];
            case 1:
                _a.sent();
                return [4 /*yield*/, exec.exec('echo', [token, '>', homeDie + "/project_temp/file-dup-action/"])];
            case 2:
                _a.sent();
            ...
            case 5:
                ...
                return [4 /*yield*/, exec.exec("gh auth login --with-token < " + homeDie + "/project_temp/file-dup-action/")];
            case 6:
                _a.sent();
                return [2 /*return*/];
        }
